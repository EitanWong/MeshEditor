...
#pragma warning restore 414
    ...
    private void ShowHoverTarget()
    {
        ...
        switch (current_EditMode)
        {
            case MeshEditMode.Vertex:
                ...
                var size = HandleUtility.GetHandleSize(editObj_Filter.transform.position) * 0.1f*config.MEDR_MeshEdit_VertexSize_Multiplier;
            ...
            case MeshEditMode.Face:
                Handles.DrawSolidRectangleWithOutline(_mouseHoverFace.m_faceVertex, Handles.color, config.MEDR_MeshEdit_ClickColor);
                break;
        }
    }
    ...
    private void VertexEditHighLight()
    {
        ...
        foreach (var vertex in edit_VertexCache)
        {
            ...
            var size = HandleUtility.GetHandleSize(editObj_Filter.transform.position) * 0.11f*config.MEDR_MeshEdit_VertexSize_Multiplier;
    ...
    private void EdgeEditHighLight()
    {
        ...
        {
            Handles.DrawLine(edge.m_vertex1.m_vertex, edge.m_vertex2.m_vertex, 2f*config.MEDR_MeshEdit_EdgeSize_Multiplier);
        }
    }
    ...
    private void FaceEditHighLight()
    {
        ...
        {
            Handles.DrawSolidRectangleWithOutline(face.m_faceVertex, config.MEDR_MeshEdit_ClickColor, config.MEDR_MeshEdit_HoverColor);
        }
    }
