...
{
    public abstract class MeshEditorPage : UnityEditor.Editor
    {
        ...
        public List<MeshEditorItem> CheckFields
        {
            get
            {
                ...
                return ParentWindow.CheckItems;
            }
        }
        ...
        internal void OnPageGUIUpdateFromMainWindow()
        {
            if (ParentWindow == null || CheckFields == null || CheckFields.Count <= 0)
            {
